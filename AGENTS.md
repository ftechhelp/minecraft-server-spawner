...
- **Startup behavior**: on startup the panel loads existing spawns but does not start them. Starts must go through the normal routes so egg capacity is enforced.
